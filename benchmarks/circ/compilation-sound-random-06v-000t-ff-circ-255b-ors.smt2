...
(assert 
  ...
  (let ((let25 (ite let1 let8 let11)))
  (let ((let26 (= let16 let25)))
  (let ((let27 (ite let4 let8 let11)))
  (let ((let28 (= let18 let27)))
  (let ((let29 (ite let5 let8 let11)))
  (let ((let30 (= let15 let29)))
  (let ((let31 (ite let0 let8 let11)))
  (let ((let32 (= let20 let31)))
  (let ((let33 (ite let3 let8 let11)))
  (let ((let34 (= let19 let33)))
  (let ((let35 (ite let2 let8 let11)))
  (let ((let36 (= let17 let35)))
