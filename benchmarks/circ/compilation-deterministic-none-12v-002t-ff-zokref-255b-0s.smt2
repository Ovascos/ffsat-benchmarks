...
(assert 
  ...
  (let ((let47 (ff.mul let35 let35)))
  (let ((let48 (= let47 let35)))
  (let ((let49 (ff.mul let7 let7)))
  (let ((let50 (= let49 let7)))
  (let ((let51 (ff.mul let11 let11)))
  (let ((let52 (= let51 let11)))
  (let ((let53 (ff.mul let15 let15)))
  (let ((let54 (= let53 let15)))
  (let ((let55 (ff.mul let19 let19)))
  (let ((let56 (= let55 let19)))
  (let ((let57 (ff.mul let43 let43)))
  (let ((let58 (= let57 let43)))
  (let ((let59 (ff.mul let23 let23)))
  (let ((let60 (= let59 let23)))
  (let ((let61 (ff.mul let39 let39)))
  (let ((let62 (= let61 let39)))
  (let ((let63 (ff.mul let44 let44)))
  (let ((let64 (= let63 let44)))
  (let ((let65 (ff.mul let24 let24)))
  (let ((let66 (= let65 let24)))
  (let ((let67 (ff.mul let27 let27)))
  (let ((let68 (= let67 let27)))
  (let ((let69 (ff.mul let31 let31)))
  (let ((let70 (= let69 let31)))
  (let ((let71 (and let70 let68 let66 let64 let62 let60 let58 let56 let54 let52 let50 let48 let46 let42 let38 let34 let30 let26 let22 let18 let14 let10 let6 let2)))
  (let ((let72 out))
  (let ((let73 _22))
  ...
  (let ((let119 (ff.mul let107 let107)))
  (let ((let120 (= let119 let107)))
  (let ((let121 (ff.mul let79 let79)))
  (let ((let122 (= let121 let79)))
  (let ((let123 (ff.mul let83 let83)))
  (let ((let124 (= let123 let83)))
  (let ((let125 (ff.mul let87 let87)))
  (let ((let126 (= let125 let87)))
  (let ((let127 (ff.mul let91 let91)))
  (let ((let128 (= let127 let91)))
  (let ((let129 (ff.mul let115 let115)))
  (let ((let130 (= let129 let115)))
  (let ((let131 (ff.mul let95 let95)))
  (let ((let132 (= let131 let95)))
  (let ((let133 (ff.mul let111 let111)))
  (let ((let134 (= let133 let111)))
  (let ((let135 (ff.mul let116 let116)))
  (let ((let136 (= let135 let116)))
  (let ((let137 (ff.mul let96 let96)))
  (let ((let138 (= let137 let96)))
  (let ((let139 (ff.mul let99 let99)))
  (let ((let140 (= let139 let99)))
  (let ((let141 (ff.mul let103 let103)))
  (let ((let142 (= let141 let103)))
  (let ((let143 (and let142 let140 let138 let136 let134 let132 let130 let128 let126 let124 let122 let120 let118 let114 let110 let106 let102 let98 let94 let90 let86 let82 let78 let74)))
  (let ((let144 (= let72 let0)))
  (let ((let145 (not let144)))
  (let ((let146 (= let107 let35)))
  (let ((let147 (= let111 let39)))
  (let ((let148 (= let96 let24)))
  (let ((let149 (= let99 let27)))
  (let ((let150 (= let87 let15)))
  (let ((let151 (= let116 let44)))
  (let ((let152 (= let79 let7)))
  (let ((let153 (= let91 let19)))
  (let ((let154 (= let95 let23)))
  (let ((let155 (= let83 let11)))
  (let ((let156 (= let115 let43)))
  (let ((let157 (= let103 let31)))
  (let ((let158 (and let157 let156 let155 let154 let153 let152 let151 let150 let149 let148 let147 let146)))
  (let ((let159 (and let158 let145 let143 let71)))
  let159
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
