...
(assert 
  ...
  (let ((let51 (not let50)))
  (let ((let52 (= let27 let2)))
  (let ((let53 (= let34 let9)))
  (let ((let54 (= let33 let8)))
  (let ((let55 (= let38 let13)))
  (let ((let56 (= let41 let16)))
  (let ((let57 (= let35 let10)))
  (let ((let58 (= let37 let12)))
  (let ((let59 (= let30 let5)))
  (let ((let60 (= let32 let7)))
  (let ((let61 (= let31 let6)))
  (let ((let62 (= let39 let14)))
  (let ((let63 (= let29 let4)))
  (let ((let64 (= let36 let11)))
  (let ((let65 (= let28 let3)))
  (let ((let66 (= let26 let1)))
  (let ((let67 (= let45 let20)))
  (let ((let68 (= let40 let15)))
  (let ((let69 (= let44 let19)))
  (let ((let70 (= let43 let18)))
  (let ((let71 (= let42 let17)))
