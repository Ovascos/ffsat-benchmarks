...
(assert 
  ...
  (let ((let77 (= let32 let76)))
  (let ((let78 (ite let0 let15 let18)))
  (let ((let79 (= let23 let78)))
  (let ((let80 (ite let2 let15 let18)))
  (let ((let81 (= let35 let80)))
  (let ((let82 (ite let7 let15 let18)))
  (let ((let83 (= let56 let82)))
  (let ((let84 (ite let12 let15 let18)))
  (let ((let85 (= let38 let84)))
  (let ((let86 (ite let3 let15 let18)))
  (let ((let87 (= let53 let86)))
