...
(assert 
  ...
  (let ((let206 (ff.add let137 let45)))
  (let ((let207 is_zero_inv_n24))
  (let ((let208 (ff.mul let207 let203)))
  (let ((let209 (= let208 let206)))
  (let ((let210 (ff.mul let96 let54)))
  (let ((let211 (ff.add let169 let95 let210 let55 let161 let91 let86)))
  (let ((let212 (ff.mul let142 let211)))
  (let ((let213 (= let212 let48)))
  (let ((let214 is_zero_inv_n22))
  (let ((let215 (ff.mul let214 let211)))
  (let ((let216 (= let215 let180)))
  (let ((let217 (ff.add let123 let45)))
  (let ((let218 (ff.mul let118 let217)))
  (let ((let219 (= let218 let94)))
  (let ((let220 (ff.add let164 let45)))
  (let ((let221 (ff.mul let117 let220)))
  (let ((let222 (= let221 let118)))
  (let ((let223 (ff.add let193 let45)))
  (let ((let224 mul_n18))
  (let ((let225 (ff.mul let224 let223)))
  (let ((let226 (= let225 let134)))
  (let ((let227 (ff.add let56 let45)))
  (let ((let228 (ff.mul let78 let227)))
  (let ((let229 (= let228 let224)))
  (let ((let230 (ff.add let96 let169 let76 let167 let117 let161)))
  (let ((let231 (ff.mul let55 let230)))
  (let ((let232 (= let231 let48)))
  (let ((let233 is_zero_inv_n16))
  (let ((let234 (ff.mul let233 let230)))
  (let ((let235 (= let234 let227)))
  (let ((let236 (ff.add let141 let123 let45)))
  (let ((let237 (ff.add let210 let45)))
  (let ((let238 (ff.mul let237 let236)))
  (let ((let239 (= let238 let138)))
  (let ((let240 (ff.add let123 let192)))
  (let ((let241 (ff.mul let75 let240)))
  (let ((let242 (= let241 let140)))
  (let ((let243 (ff.add let165 let139)))
  (let ((let244 (ff.mul let88 let243)))
  (let ((let245 (= let244 let74)))
  (let ((let246 (and let245 let242 let239 let235 let232 let229 let226 let222 let219 let216 let213 let209 let205 let200 let196 let191 let186 let182 let177 let173 let159 let156 let151 let147 let132 let129 let122 let116 let107 let104 let99 let85 let80 let72 let69)))
  (let ((let247 (ite let3 let45 let48)))
  (let ((let248 (= let165 let247)))
  (let ((let249 (ite let14 let45 let48)))
  (let ((let250 (= let167 let249)))
  (let ((let251 (ite let12 let45 let48)))
  (let ((let252 (= let169 let251)))
  (let ((let253 (ite let2 let45 let48)))
  (let ((let254 (= let73 let253)))
  (let ((let255 (ite let15 let45 let48)))
  (let ((let256 (= let161 let255)))
  (let ((let257 (ite let11 let45 let48)))
  (let ((let258 (= let76 let257)))
  (let ((let259 (ite let0 let45 let48)))
  (let ((let260 (= let91 let259)))
  (let ((let261 (ite let13 let45 let48)))
  (let ((let262 (= let117 let261)))
  (let ((let263 (ite let1 let45 let48)))
  (let ((let264 (= let192 let263)))
  (let ((let265 (ite let20 let45 let48)))
  (let ((let266 (= let163 let265)))
  (let ((let267 (ite let4 let45 let48)))
  (let ((let268 (= let88 let267)))
  (let ((let269 (ite let7 let45 let48)))
  (let ((let270 (= let96 let269)))
  (let ((let271 (and let270 let268 let266 let264 let262 let260 let258 let256 let254 let252 let250 let248)))
  (let ((let272 (and let271 let246)))
  (let ((let273 (=> let272 let51)))
