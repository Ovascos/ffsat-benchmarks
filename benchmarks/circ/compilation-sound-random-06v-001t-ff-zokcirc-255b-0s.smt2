...
(assert 
  ...
  (let ((let32 (and let31 let27 let22 let18)))
  (let ((let33 (ite let2 let8 let11)))
  (let ((let34 d_n1))
  (let ((let35 (= let34 let33)))
  (let ((let36 (ite let0 let8 let11)))
  (let ((let37 (= let15 let36)))
  (let ((let38 (ite let1 let8 let11)))
  (let ((let39 (= let19 let38)))
  (let ((let40 (ite let3 let8 let11)))
  (let ((let41 (= let24 let40)))
  (let ((let42 (ite let4 let8 let11)))
  (let ((let43 (= let28 let42)))
  (let ((let44 (ite let5 let8 let11)))
  (let ((let45 (= let29 let44)))
