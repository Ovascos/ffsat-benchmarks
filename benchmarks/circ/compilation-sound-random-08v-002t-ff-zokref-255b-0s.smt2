...
(assert 
  ...
  (let ((let59 (ff.mul let49 let49)))
  (let ((let60 (= let59 let49)))
  (let ((let61 (ff.mul let39 let39)))
  (let ((let62 (= let61 let39)))
  (let ((let63 (ff.mul let43 let43)))
  (let ((let64 (= let63 let43)))
  (let ((let65 (ff.mul let44 let44)))
  (let ((let66 (= let65 let44)))
  (let ((let67 (and let66 let64 let62 let60 let58 let56 let54 let52 let46 let42 let38 let34 let30 let26 let19)))
  (let ((let68 (ite let3 let11 let14)))
  (let ((let69 (= let27 let68)))
  (let ((let70 (ite let4 let11 let14)))
  (let ((let71 (= let31 let70)))
  (let ((let72 (ite let1 let11 let14)))
  (let ((let73 (= let49 let72)))
  (let ((let74 (ite let0 let11 let14)))
  (let ((let75 (= let47 let74)))
  (let ((let76 (ite let7 let11 let14)))
  (let ((let77 (= let43 let76)))
  (let ((let78 (ite let8 let11 let14)))
  (let ((let79 (= let44 let78)))
  (let ((let80 (ite let6 let11 let14)))
  (let ((let81 (= let39 let80)))
  (let ((let82 (ite let5 let11 let14)))
  (let ((let83 (= let35 let82)))
  (let ((let84 (and let83 let81 let79 let77 let75 let73 let71 let69)))
  (let ((let85 (and let84 let67)))
