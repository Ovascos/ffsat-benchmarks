...
(assert 
  ...
  (let ((let47 (not let46)))
  (let ((let48 (= let40 let17)))
  (let ((let49 (= let34 let11)))
  (let ((let50 (= let24 let1)))
  (let ((let51 (= let32 let9)))
  (let ((let52 (= let29 let6)))
  (let ((let53 (= let38 let15)))
  (let ((let54 (= let41 let18)))
  (let ((let55 (= let30 let7)))
  (let ((let56 (= let31 let8)))
  (let ((let57 (= let27 let4)))
  (let ((let58 (= let35 let12)))
  (let ((let59 (= let26 let3)))
  (let ((let60 (= let28 let5)))
  (let ((let61 (= let33 let10)))
  (let ((let62 (= let37 let14)))
  (let ((let63 (= let36 let13)))
  (let ((let64 (= let39 let16)))
  (let ((let65 (= let25 let2)))
