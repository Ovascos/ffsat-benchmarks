...
(assert 
  ...
  (let ((let61 (ite let2 let16 let19)))
  (let ((let62 (= let31 let61)))
  (let ((let63 (ite let1 let16 let19)))
  (let ((let64 (= let53 let63)))
  (let ((let65 (ite let9 let16 let19)))
  (let ((let66 (= let35 let65)))
  (let ((let67 (ite let10 let16 let19)))
  (let ((let68 (= let37 let67)))
  (let ((let69 (ite let3 let16 let19)))
  (let ((let70 (= let27 let69)))
  (let ((let71 (ite let13 let16 let19)))
  (let ((let72 (= let47 let71)))
  (let ((let73 (ite let11 let16 let19)))
  (let ((let74 (= let43 let73)))
  (let ((let75 (ite let7 let16 let19)))
  (let ((let76 (= let33 let75)))
  (let ((let77 (ite let5 let16 let19)))
  (let ((let78 (= let45 let77)))
  (let ((let79 (ite let0 let16 let19)))
  (let ((let80 (= let29 let79)))
  (let ((let81 (ite let8 let16 let19)))
  (let ((let82 (= let39 let81)))
  (let ((let83 (ite let12 let16 let19)))
  (let ((let84 (= let51 let83)))
  (let ((let85 (ite let6 let16 let19)))
