...
(assert 
  ...
  (let ((let90 (ite let7 let14 let17)))
  (let ((let91 (= let51 let90)))
  (let ((let92 (ite let0 let14 let17)))
  (let ((let93 (= let23 let92)))
  (let ((let94 (ite let5 let14 let17)))
  (let ((let95 (= let43 let94)))
  (let ((let96 (ite let10 let14 let17)))
  (let ((let97 (= let63 let96)))
  (let ((let98 (ite let6 let14 let17)))
  (let ((let99 (= let47 let98)))
  (let ((let100 (ite let1 let14 let17)))
  (let ((let101 (= let27 let100)))
  (let ((let102 (ite let2 let14 let17)))
  (let ((let103 (= let31 let102)))
  (let ((let104 (ite let3 let14 let17)))
  (let ((let105 (= let35 let104)))
  (let ((let106 (ite let4 let14 let17)))
  (let ((let107 (= let39 let106)))
  (let ((let108 (ite let9 let14 let17)))
  (let ((let109 (= let59 let108)))
  (let ((let110 (ite let11 let14 let17)))
  (let ((let111 (= let64 let110)))
  (let ((let112 (ite let8 let14 let17)))
