...
(assert 
  ...
  (let ((let98 (not let97)))
  (let ((let99 (= let57 let10)))
  (let ((let100 (= let65 let18)))
  (let ((let101 (= let55 let8)))
  (let ((let102 (= let63 let16)))
  (let ((let103 (= let83 let36)))
  (let ((let104 (= let89 let42)))
  (let ((let105 (= let67 let20)))
  (let ((let106 (= let73 let26)))
  (let ((let107 (= let75 let28)))
  (let ((let108 (= let71 let24)))
  (let ((let109 (= let79 let32)))
  (let ((let110 (= let77 let30)))
  (let ((let111 (= let59 let12)))
  (let ((let112 (= let85 let38)))
  (let ((let113 (= let87 let40)))
  (let ((let114 (= let61 let14)))
  (let ((let115 (= let53 let6)))
  (let ((let116 (= let81 let34)))
  (let ((let117 (= let91 let44)))
  (let ((let118 (= let69 let22)))
