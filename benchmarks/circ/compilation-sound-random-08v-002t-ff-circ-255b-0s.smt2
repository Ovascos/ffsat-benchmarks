...
(assert 
  ...
  (let ((let43 (and let42 let38)))
  (let ((let44 (ite let5 let11 let14)))
  (let ((let45 (= let28 let44)))
  (let ((let46 (ite let3 let11 let14)))
  (let ((let47 (= let21 let46)))
  (let ((let48 (ite let6 let11 let14)))
  (let ((let49 (= let30 let48)))
  (let ((let50 (ite let1 let11 let14)))
  (let ((let51 (= let19 let50)))
  (let ((let52 (ite let4 let11 let14)))
  (let ((let53 (= let32 let52)))
  (let ((let54 (ite let7 let11 let14)))
  (let ((let55 (= let34 let54)))
  (let ((let56 (ite let0 let11 let14)))
  (let ((let57 (= let25 let56)))
  (let ((let58 (ite let8 let11 let14)))
  (let ((let59 (= let26 let58)))
