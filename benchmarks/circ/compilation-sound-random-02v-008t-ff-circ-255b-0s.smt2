...
(assert 
  ...
  (let ((let39 (ff.add let38 let25 let29 let18)))
  (let ((let40 (ff.mul let24 let18)))
  (let ((let41 (ff.add let40 let11)))
  (let ((let42 (ff.mul let41 let39)))
  (let ((let43 (= let42 let36)))
  (let ((let44 (ff.mul let25 let29)))
  (let ((let45 (= let44 let37)))
  (let ((let46 (ff.mul let30 let29)))
  (let ((let47 (= let46 let31)))
  (let ((let48 (ff.mul let25 let24)))
  (let ((let49 (= let48 let21)))
  (let ((let50 (and let49 let47 let45 let43 let35)))
  (let ((let51 (ite let4 let11 let14)))
  (let ((let52 (= let29 let51)))
  (let ((let53 (ite let0 let11 let14)))
  (let ((let54 (= let24 let53)))
  (let ((let55 (and let54 let52)))
  (let ((let56 (and let55 let50)))
  (let ((let57 (=> let56 let17)))
  (let ((let58 (not let57)))
  let58
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
