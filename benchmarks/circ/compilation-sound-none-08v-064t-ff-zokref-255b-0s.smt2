...
(assert 
  ...
  (let ((let521 (ite let0 let71 let74)))
  (let ((let522 (= let305 let521)))
  (let ((let523 (ite let10 let71 let74)))
  (let ((let524 (= let204 let523)))
  (let ((let525 (ite let5 let71 let74)))
  (let ((let526 (= let312 let525)))
  (let ((let527 (ite let11 let71 let74)))
  (let ((let528 (= let385 let527)))
  (let ((let529 (ite let6 let71 let74)))
  (let ((let530 (= let238 let529)))
  (let ((let531 (ite let9 let71 let74)))
  (let ((let532 (= let340 let531)))
