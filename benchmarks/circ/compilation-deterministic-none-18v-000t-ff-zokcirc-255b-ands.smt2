...
(assert 
  ...
  (let ((let57 x3_n7_alt))
  (let ((let58 mul_n20_alt))
  (let ((let59 (ff.mul let58 let57)))
  (let ((let60 (= let59 let54)))
  (let ((let61 x2_n18_alt))
  (let ((let62 mul_n19_alt))
  (let ((let63 (ff.mul let62 let61)))
  (let ((let64 (= let63 let58)))
  (let ((let65 x1_n13_alt))
  (let ((let66 x0_n5_alt))
  (let ((let67 (ff.mul let66 let65)))
  (let ((let68 (= let67 let62)))
  (let ((let69 (and let68 let64 let60 let56 let52 let48 let44 let40 let36 let32 let28 let24 let20 let16 let12 let8 let4)))
  (let ((let70 return_n17))
  (let ((let71 x17_n11))
  (let ((let72 mul_n34))
  ...
  (let ((let139 (and let138 let134 let130 let126 let122 let118 let114 let110 let106 let102 let98 let94 let90 let86 let82 let78 let74)))
  (let ((let140 (= let70 let0)))
  (let ((let141 (not let140)))
  (let ((let142 (= let79 let9)))
  (let ((let143 (= let111 let41)))
  (let ((let144 (= let103 let33)))
  (let ((let145 (= let123 let53)))
  (let ((let146 (= let119 let49)))
  (let ((let147 (= let87 let17)))
  (let ((let148 (= let99 let29)))
  (let ((let149 (= let115 let45)))
  (let ((let150 (= let71 let1)))
  (let ((let151 (= let135 let65)))
  (let ((let152 (= let75 let5)))
  (let ((let153 (= let95 let25)))
  (let ((let154 (= let131 let61)))
  (let ((let155 (= let127 let57)))
  (let ((let156 (= let107 let37)))
  (let ((let157 (= let136 let66)))
  (let ((let158 (= let83 let13)))
  (let ((let159 (= let91 let21)))
  (let ((let160 (and let159 let158 let157 let156 let155 let154 let153 let152 let151 let150 let149 let148 let147 let146 let145 let144 let143 let142)))
  (let ((let161 (and let160 let141 let139 let69)))
  let161
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
