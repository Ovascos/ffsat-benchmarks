...
(assert 
  ...
  (let ((let35 (not let34)))
  (let ((let36 (= let28 let11)))
  (let ((let37 (= let23 let6)))
  (let ((let38 (= let27 let10)))
  (let ((let39 (= let26 let9)))
  (let ((let40 (= let18 let1)))
  (let ((let41 (= let20 let3)))
  (let ((let42 (= let22 let5)))
  (let ((let43 (= let25 let8)))
  (let ((let44 (= let29 let12)))
  (let ((let45 (= let21 let4)))
  (let ((let46 (= let19 let2)))
