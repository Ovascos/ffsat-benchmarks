...
(assert 
  ...
  (let ((let28 (as ff576460752303423618 FF0)))
  (let ((let29 _21))
  ...
  (let ((let122 (ite let5 let12 let15)))
  (let ((let123 (= let35 let122)))
  (let ((let124 (ite let2 let12 let15)))
  (let ((let125 (= let51 let124)))
  (let ((let126 (ite let1 let12 let15)))
  (let ((let127 (= let69 let126)))
  (let ((let128 (ite let0 let12 let15)))
  (let ((let129 (= let20 let128)))
