...
(assert 
  ...
  (let ((let51 (ff.mul let14 let23)))
  (let ((let52 (ff.add let51 let15)))
  (let ((let53 is_zero_inv_n14))
  ...
  (let ((let60 (and let59 let55 let50)))
  (let ((let61 (ite let12 let15 let18)))
  (let ((let62 (= let28 let61)))
  (let ((let63 (ite let4 let15 let18)))
  (let ((let64 (= let24 let63)))
  (let ((let65 (ite let3 let15 let18)))
  (let ((let66 (= let36 let65)))
  (let ((let67 (ite let6 let15 let18)))
  (let ((let68 (= let34 let67)))
  (let ((let69 (ite let11 let15 let18)))
  (let ((let70 (= let42 let69)))
  (let ((let71 (ite let1 let15 let18)))
  (let ((let72 (= let33 let71)))
  (let ((let73 (ite let5 let15 let18)))
  (let ((let74 (= let40 let73)))
  (let ((let75 (ite let7 let15 let18)))
  (let ((let76 (= let46 let75)))
  (let ((let77 (ite let8 let15 let18)))
  (let ((let78 (= let30 let77)))
  (let ((let79 (ite let9 let15 let18)))
  (let ((let80 (= let38 let79)))
  (let ((let81 (ite let10 let15 let18)))
  (let ((let82 (= let26 let81)))
  (let ((let83 (ite let0 let15 let18)))
  (let ((let84 (= let32 let83)))
  (let ((let85 (and let84 let82 let80 let78 let76 let74 let72 let70 let68 let66 let64 let62)))
  (let ((let86 (and let85 let60)))
