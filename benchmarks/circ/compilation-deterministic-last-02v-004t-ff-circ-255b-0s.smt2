...
(assert 
  (let ((let0 (as ff0 FF0)))
  (let ((let1 (as ff5 FF0)))
  (let ((let2 (as ff52435875175126190479447740508185965837690552500527637822603658699938581184510 FF0)))
  (let ((let3 a_n2_alt))
  (let ((let4 (ff.mul let3 let2)))
  (let ((let5 (as ff52435875175126190479447740508185965837690552500527637822603658699938581184511 FF0)))
  (let ((let6 b_n1_alt))
  ...
  (let ((let37 (not let36)))
  (let ((let38 (= let22 let6)))
  (let ((let39 (= let20 let3)))
