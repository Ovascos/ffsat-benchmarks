...
(assert 
  ...
  (let ((let216 (= let215 let206)))
  (let ((let217 (and let216 let208 let202 let196 let190 let184 let178 let172 let166 let160 let154 let148 let142 let136 let130 let124 let118)))
  (let ((let218 (= let110 let2)))
  (let ((let219 (not let218)))
  (let ((let220 (= let167 let59)))
  (let ((let221 (= let185 let77)))
  (let ((let222 (= let113 let5)))
  (let ((let223 (= let212 let104)))
  (let ((let224 (= let119 let11)))
  (let ((let225 (= let149 let41)))
  (let ((let226 (= let203 let95)))
  (let ((let227 (= let179 let71)))
  (let ((let228 (= let209 let101)))
  (let ((let229 (= let173 let65)))
  (let ((let230 (= let191 let83)))
  (let ((let231 (= let131 let23)))
  (let ((let232 (= let125 let17)))
  (let ((let233 (= let155 let47)))
  (let ((let234 (= let161 let53)))
  (let ((let235 (= let137 let29)))
  (let ((let236 (= let143 let35)))
  (let ((let237 (= let197 let89)))
  (let ((let238 (and let237 let236 let235 let234 let233 let232 let231 let230 let229 let228 let227 let226 let225 let224 let223 let222 let221 let220)))
  (let ((let239 (and let238 let219 let217 let109)))
  let239
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
