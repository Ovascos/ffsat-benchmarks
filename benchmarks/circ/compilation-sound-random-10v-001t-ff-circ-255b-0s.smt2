...
(assert 
  ...
  (let ((let33 (ite let5 let12 let15)))
  (let ((let34 (= let22 let33)))
  (let ((let35 (ite let8 let12 let15)))
  (let ((let36 (= let28 let35)))
  (let ((let37 (ite let6 let12 let15)))
  (let ((let38 (= let26 let37)))
  (let ((let39 (ite let1 let12 let15)))
  (let ((let40 (= let23 let39)))
  (let ((let41 (ite let3 let12 let15)))
  (let ((let42 (= let21 let41)))
  (let ((let43 (ite let9 let12 let15)))
  (let ((let44 (= let27 let43)))
  (let ((let45 (ite let2 let12 let15)))
  (let ((let46 (= let24 let45)))
  (let ((let47 (ite let4 let12 let15)))
  (let ((let48 (= let25 let47)))
  (let ((let49 (ite let7 let12 let15)))
  (let ((let50 (= let20 let49)))
  (let ((let51 (ite let0 let12 let15)))
  (let ((let52 (= let19 let51)))
