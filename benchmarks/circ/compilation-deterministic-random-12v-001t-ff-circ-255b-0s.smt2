...
(assert 
  ...
  (let ((let35 (not let34)))
  (let ((let36 (= let29 let12)))
  (let ((let37 (= let19 let2)))
  (let ((let38 (= let18 let1)))
  (let ((let39 (= let26 let9)))
  (let ((let40 (= let28 let11)))
  (let ((let41 (= let27 let10)))
  (let ((let42 (= let22 let5)))
  (let ((let43 (= let23 let6)))
  (let ((let44 (= let25 let8)))
  (let ((let45 (= let24 let7)))
  (let ((let46 (= let20 let3)))
  (let ((let47 (= let21 let4)))
