...
(assert 
  ...
  (let ((let53 x2_n16_alt))
  (let ((let54 mul_n17_alt))
  (let ((let55 (ff.mul let54 let53)))
  (let ((let56 (= let55 let50)))
  (let ((let57 x1_n11_alt))
  (let ((let58 x0_n4_alt))
  (let ((let59 (ff.mul let58 let57)))
  (let ((let60 (= let59 let54)))
  (let ((let61 (and let60 let56 let52 let48 let44 let40 let36 let32 let28 let24 let20 let16 let12 let8 let4)))
  (let ((let62 return_n15))
  (let ((let63 x15_n13))
  (let ((let64 mul_n30))
  ...
  (let ((let123 (and let122 let118 let114 let110 let106 let102 let98 let94 let90 let86 let82 let78 let74 let70 let66)))
  (let ((let124 (= let62 let0)))
  (let ((let125 (not let124)))
  (let ((let126 (= let103 let41)))
  (let ((let127 (= let115 let53)))
  (let ((let128 (= let71 let9)))
  (let ((let129 (= let79 let17)))
  (let ((let130 (= let119 let57)))
  (let ((let131 (= let63 let1)))
  (let ((let132 (= let107 let45)))
  (let ((let133 (= let95 let33)))
  (let ((let134 (= let75 let13)))
  (let ((let135 (= let67 let5)))
  (let ((let136 (= let91 let29)))
  (let ((let137 (= let120 let58)))
  (let ((let138 (= let99 let37)))
  (let ((let139 (= let111 let49)))
  (let ((let140 (= let83 let21)))
  (let ((let141 (= let87 let25)))
  (let ((let142 (and let141 let140 let139 let138 let137 let136 let135 let134 let133 let132 let131 let130 let129 let128 let127 let126)))
  (let ((let143 (and let142 let125 let123 let61)))
  let143
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
