...
(assert 
  ...
  (let ((let78 (ite let0 let10 let13)))
  (let ((let79 (= let21 let78)))
  (let ((let80 (ite let1 let10 let13)))
  (let ((let81 (= let27 let80)))
  (let ((let82 (ite let2 let10 let13)))
  (let ((let83 (= let33 let82)))
  (let ((let84 (ite let4 let10 let13)))
  (let ((let85 (= let45 let84)))
  (let ((let86 (ite let3 let10 let13)))
  (let ((let87 (= let39 let86)))
  (let ((let88 (ite let5 let10 let13)))
  (let ((let89 (= let51 let88)))
  (let ((let90 (ite let6 let10 let13)))
  (let ((let91 (= let56 let90)))
  (let ((let92 (ite let7 let10 let13)))
  (let ((let93 (= let57 let92)))
