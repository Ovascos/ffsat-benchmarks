...
(assert 
  ...
  (let ((let67 (ite let10 let14 let17)))
  (let ((let68 (= let58 let67)))
  (let ((let69 (ite let7 let14 let17)))
  (let ((let70 (= let46 let69)))
  (let ((let71 (ite let11 let14 let17)))
  (let ((let72 (= let59 let71)))
  (let ((let73 (ite let1 let14 let17)))
  (let ((let74 (= let25 let73)))
  (let ((let75 (ite let5 let14 let17)))
  (let ((let76 g_n11))
  (let ((let77 (= let76 let75)))
  (let ((let78 (ite let4 let14 let17)))
  (let ((let79 (= let37 let78)))
  (let ((let80 (ite let8 let14 let17)))
  (let ((let81 (= let50 let80)))
  (let ((let82 (ite let6 let14 let17)))
  (let ((let83 (= let42 let82)))
  (let ((let84 (ite let9 let14 let17)))
  (let ((let85 (= let54 let84)))
  (let ((let86 (ite let3 let14 let17)))
  (let ((let87 (= let33 let86)))
  (let ((let88 (and let87 let85 let83 let81 let79 let77 let74 let72 let70 let68 let66 let64)))
