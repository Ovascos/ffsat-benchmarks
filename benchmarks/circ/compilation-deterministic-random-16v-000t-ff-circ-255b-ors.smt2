...
(assert 
  ...
  (let ((let43 (not let42)))
  (let ((let44 (= let35 let14)))
  (let ((let45 (= let33 let12)))
  (let ((let46 (= let24 let3)))
  (let ((let47 (= let36 let15)))
  (let ((let48 (= let29 let8)))
  (let ((let49 (= let22 let1)))
  (let ((let50 (= let25 let4)))
  (let ((let51 (= let26 let5)))
  (let ((let52 (= let23 let2)))
  (let ((let53 (= let31 let10)))
  (let ((let54 (= let34 let13)))
  (let ((let55 (= let27 let6)))
  (let ((let56 (= let37 let16)))
  (let ((let57 (= let32 let11)))
  (let ((let58 (= let30 let9)))
  (let ((let59 (= let28 let7)))
