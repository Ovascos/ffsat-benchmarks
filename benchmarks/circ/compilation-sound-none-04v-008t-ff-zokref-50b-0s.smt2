...
(assert 
  ...
  (let ((let29 (as ff562949953421380 FF0)))
  (let ((let30 _21))
  ...
  (let ((let123 (ite let0 let12 let15)))
  (let ((let124 (= let21 let123)))
  (let ((let125 (ite let5 let12 let15)))
  (let ((let126 (= let36 let125)))
  (let ((let127 (ite let1 let12 let15)))
  (let ((let128 (= let70 let127)))
  (let ((let129 (ite let2 let12 let15)))
  (let ((let130 (= let52 let129)))
