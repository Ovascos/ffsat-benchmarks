...
(assert 
  ...
  (let ((let82 (not let81)))
  (let ((let83 (= let49 let10)))
  (let ((let84 (= let75 let36)))
  (let ((let85 (= let67 let28)))
  (let ((let86 (= let59 let20)))
  (let ((let87 (= let55 let16)))
  (let ((let88 (= let53 let14)))
  (let ((let89 (= let73 let34)))
  (let ((let90 (= let61 let22)))
  (let ((let91 (= let63 let24)))
  (let ((let92 (= let69 let30)))
  (let ((let93 (= let45 let6)))
  (let ((let94 (= let71 let32)))
  (let ((let95 (= let51 let12)))
  (let ((let96 (= let65 let26)))
  (let ((let97 (= let57 let18)))
  (let ((let98 (= let47 let8)))
