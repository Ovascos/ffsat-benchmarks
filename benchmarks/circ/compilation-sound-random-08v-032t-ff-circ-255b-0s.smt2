...
(assert 
  ...
  (let ((let145 (ff.mul let118 let108)))
  (let ((let146 (= let145 let107)))
  (let ((let147 (ff.mul let99 let49)))
  (let ((let148 (ff.mul let117 let49)))
  (let ((let149 (ff.add let148 let147 let40)))
  (let ((let150 (ff.add let147 let40)))
  (let ((let151 (ff.mul let150 let149)))
  (let ((let152 (= let151 let116)))
  (let ((let153 (as ff4 FF0)))
  (let ((let154 (ff.mul let106 let101)))
  (let ((let155 (ff.mul let70 let49)))
  (let ((let156 (ff.add let155 let131 let154 let153)))
  (let ((let157 (ff.mul let108 let156)))
  (let ((let158 (= let157 let43)))
  (let ((let159 (ff.mul let108 let49)))
  ...
  (let ((let165 (ff.mul let133 let164)))
  (let ((let166 (ff.add let142 let165 let47)))
  (let ((let167 (ff.mul let106 let166)))
  (let ((let168 (= let167 let43)))
  (let ((let169 (ff.mul let106 let49)))
  ...
  (let ((let175 (ff.mul let72 let100)))
  (let ((let176 (ff.mul let175 let174)))
  (let ((let177 (= let176 let71)))
  (let ((let178 (ff.mul let142 let49)))
  (let ((let179 b_n6))
  (let ((let180 c_n4))
  (let ((let181 (ff.add let180 let117 let179 let178 let40)))
  (let ((let182 (ff.mul let70 let181)))
  (let ((let183 (= let182 let43)))
  (let ((let184 is_zero_inv_n15))
  (let ((let185 (ff.mul let184 let181)))
  (let ((let186 (= let185 let174)))
  (let ((let187 a_n8))
  (let ((let188 (ff.mul let180 let100)))
  (let ((let189 (ff.add let175 let99 let188 let117 let187 let131 let179 let130 let40)))
  (let ((let190 (ff.mul let142 let189)))
  ...
  (let ((let199 (ff.add let131 let134 let40)))
  ...
  (let ((let206 (ff.add let121 let130 let49)))
  (let ((let207 (ff.mul let187 let206)))
  (let ((let208 (= let207 let134)))
  (let ((let209 (ff.mul let179 let49)))
  (let ((let210 (ff.add let209 let40)))
  (let ((let211 (ff.mul let187 let210)))
  (let ((let212 (= let211 let121)))
  (let ((let213 (and let212 let208 let205 let201 let195 let191 let186 let183 let177 let173 let168 let163 let158 let152 let146 let144 let141 let137 let129 let124 let120 let115 let112 let105 let98 let93 let89 let83 let77 let69 let66)))
  (let ((let214 (ite let10 let40 let43)))
  (let ((let215 (= let117 let214)))
  (let ((let216 (ite let3 let40 let43)))
  (let ((let217 (= let180 let216)))
  (let ((let218 (ite let8 let40 let43)))
  (let ((let219 (= let72 let218)))
  (let ((let220 (ite let4 let40 let43)))
  (let ((let221 (= let130 let220)))
  (let ((let222 (ite let14 let40 let43)))
  (let ((let223 (= let133 let222)))
  (let ((let224 (ite let0 let40 let43)))
  (let ((let225 (= let179 let224)))
  (let ((let226 (ite let1 let40 let43)))
  (let ((let227 (= let187 let226)))
  (let ((let228 (ite let9 let40 let43)))
  (let ((let229 (= let99 let228)))
