...
(assert 
  ...
  (let ((let37 (ite let11 let14 let17)))
  (let ((let38 (= let30 let37)))
  (let ((let39 (ite let5 let14 let17)))
  (let ((let40 (= let26 let39)))
  (let ((let41 (ite let3 let14 let17)))
  (let ((let42 (= let32 let41)))
  (let ((let43 (ite let0 let14 let17)))
  (let ((let44 (= let24 let43)))
  (let ((let45 (ite let7 let14 let17)))
  (let ((let46 (= let21 let45)))
  (let ((let47 (ite let10 let14 let17)))
  (let ((let48 (= let22 let47)))
  (let ((let49 (ite let4 let14 let17)))
  (let ((let50 (= let25 let49)))
  (let ((let51 (ite let8 let14 let17)))
  (let ((let52 (= let31 let51)))
  (let ((let53 (ite let9 let14 let17)))
  ...
  (let ((let59 (ite let1 let14 let17)))
  (let ((let60 (= let29 let59)))
