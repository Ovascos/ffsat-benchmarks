...
(assert 
  ...
  (let ((let29 (ite let6 let10 let13)))
  (let ((let30 (= let18 let29)))
  (let ((let31 (ite let5 let10 let13)))
  (let ((let32 (= let20 let31)))
  (let ((let33 (ite let7 let10 let13)))
  (let ((let34 (= let22 let33)))
  (let ((let35 (ite let4 let10 let13)))
  (let ((let36 (= let23 let35)))
  (let ((let37 (ite let2 let10 let13)))
  (let ((let38 (= let24 let37)))
  (let ((let39 (ite let3 let10 let13)))
