...
(assert 
  ...
  (let ((let114 (= let66 let11)))
  (let ((let115 (= let85 let30)))
  (let ((let116 (= let78 let23)))
  (let ((let117 (= let91 let36)))
  (let ((let118 (= let103 let48)))
  (let ((let119 (= let106 let51)))
  (let ((let120 f_n1_alt))
  (let ((let121 f_n1))
  (let ((let122 (= let121 let120)))
  (let ((let123 (= let60 let5)))
  (let ((let124 (= let72 let17)))
  (let ((let125 (= let97 let42)))
  (let ((let126 (and let125 let124 let123 let122 let119 let118 let117 let116 let115 let114)))
