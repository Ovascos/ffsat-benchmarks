...
(assert 
  ...
  (let ((let130 return_n10_alt))
  (let ((let131 return_n10))
  (let ((let132 (= let131 let130)))
  (let ((let133 (not let132)))
  (let ((let134 (= let91 let27)))
  (let ((let135 x11_n3_alt))
  (let ((let136 x11_n3))
  (let ((let137 (= let136 let135)))
  (let ((let138 (= let79 let15)))
  (let ((let139 (= let103 let39)))
  (let ((let140 (= let109 let45)))
  (let ((let141 (= let124 let60)))
  (let ((let142 (= let97 let33)))
  (let ((let143 (= let73 let9)))
  (let ((let144 (= let85 let21)))
  (let ((let145 (= let67 let3)))
  (let ((let146 (= let121 let57)))
  (let ((let147 (= let115 let51)))
  (let ((let148 (and let147 let146 let145 let144 let143 let142 let141 let140 let139 let138 let137 let134)))
