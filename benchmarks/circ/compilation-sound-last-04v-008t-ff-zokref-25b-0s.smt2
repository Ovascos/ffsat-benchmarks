...
(assert 
  ...
  (let ((let122 (ite let1 let12 let15)))
  (let ((let123 (= let69 let122)))
  (let ((let124 (ite let0 let12 let15)))
  (let ((let125 (= let20 let124)))
  (let ((let126 (ite let2 let12 let15)))
  (let ((let127 (= let51 let126)))
  (let ((let128 (ite let5 let12 let15)))
