...
(assert 
  ...
  (let ((let63 (ff.mul let55 let55)))
  (let ((let64 (= let63 let55)))
  (let ((let65 (ff.mul let38 let38)))
  (let ((let66 (= let65 let38)))
  ...
  (let ((let73 (and let72 let70 let68 let66 let64 let62 let60 let58 let52 let46 let40 let36 let29 let25 let21)))
  (let ((let74 (ite let9 let13 let16)))
  (let ((let75 (= let37 let74)))
  (let ((let76 (ite let0 let13 let16)))
  (let ((let77 (= let54 let76)))
  (let ((let78 (ite let4 let13 let16)))
  (let ((let79 (= let48 let78)))
  (let ((let80 (ite let7 let13 let16)))
  (let ((let81 (= let41 let80)))
  (let ((let82 (ite let6 let13 let16)))
  (let ((let83 (= let42 let82)))
  (let ((let84 (ite let1 let13 let16)))
  (let ((let85 (= let55 let84)))
  (let ((let86 (ite let10 let13 let16)))
  (let ((let87 (= let38 let86)))
  (let ((let88 (ite let3 let13 let16)))
  (let ((let89 (= let49 let88)))
  (let ((let90 (and let89 let87 let85 let83 let81 let79 let77 let75)))
  (let ((let91 (and let90 let73)))
