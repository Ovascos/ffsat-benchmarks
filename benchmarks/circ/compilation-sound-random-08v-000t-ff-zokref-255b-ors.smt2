...
(assert 
  ...
  (let ((let77 (ite let6 let10 let13)))
  (let ((let78 (= let57 let77)))
  (let ((let79 (ite let0 let10 let13)))
  (let ((let80 (= let22 let79)))
  (let ((let81 (ite let1 let10 let13)))
  (let ((let82 (= let28 let81)))
  (let ((let83 (ite let2 let10 let13)))
  (let ((let84 (= let34 let83)))
  (let ((let85 (ite let3 let10 let13)))
  (let ((let86 (= let40 let85)))
  (let ((let87 (ite let7 let10 let13)))
  (let ((let88 (= let58 let87)))
  (let ((let89 (ite let4 let10 let13)))
  (let ((let90 (= let46 let89)))
  (let ((let91 (ite let5 let10 let13)))
  (let ((let92 (= let52 let91)))
