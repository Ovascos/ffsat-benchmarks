...
(assert 
  ...
  (let ((let70 (ff.mul let6 let6)))
  (let ((let71 (= let70 let6)))
  (let ((let72 (ff.mul let12 let12)))
  (let ((let73 (= let72 let12)))
  (let ((let74 (ff.mul let18 let18)))
  (let ((let75 (= let74 let18)))
  ...
  (let ((let164 (ff.mul let100 let100)))
  (let ((let165 (= let164 let100)))
  (let ((let166 (ff.mul let106 let106)))
  (let ((let167 (= let166 let106)))
  (let ((let168 (ff.mul let112 let112)))
  (let ((let169 (= let168 let112)))
  (let ((let170 (ff.mul let118 let118)))
  (let ((let171 (= let170 let118)))
  (let ((let172 (ff.mul let124 let124)))
  (let ((let173 (= let172 let124)))
  (let ((let174 (ff.mul let130 let130)))
  (let ((let175 (= let174 let130)))
  (let ((let176 (ff.mul let136 let136)))
  (let ((let177 (= let176 let136)))
  (let ((let178 (ff.mul let142 let142)))
  (let ((let179 (= let178 let142)))
  (let ((let180 (ff.mul let148 let148)))
  (let ((let181 (= let180 let148)))
  (let ((let182 (ff.mul let154 let154)))
  (let ((let183 (= let182 let154)))
  ...
  (let ((let191 (= let112 let18)))
  (let ((let192 (= let136 let42)))
  (let ((let193 (= let142 let48)))
  (let ((let194 (= let159 let65)))
  (let ((let195 (= let118 let24)))
  (let ((let196 (= let154 let60)))
  (let ((let197 (= let160 let66)))
  (let ((let198 (= let106 let12)))
  (let ((let199 (= let100 let6)))
  (let ((let200 (= let130 let36)))
  (let ((let201 (= let148 let54)))
  (let ((let202 (= let124 let30)))
