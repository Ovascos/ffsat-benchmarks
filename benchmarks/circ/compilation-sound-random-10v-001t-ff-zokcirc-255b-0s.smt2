...
(assert 
  ...
  (let ((let75 (= let65 let74)))
  (let ((let76 (ite let1 let12 let15)))
  (let ((let77 (= let28 let76)))
  (let ((let78 (ite let6 let12 let15)))
  (let ((let79 (= let53 let78)))
  (let ((let80 (ite let2 let12 let15)))
  (let ((let81 (= let34 let80)))
  (let ((let82 (ite let0 let12 let15)))
  (let ((let83 (= let22 let82)))
  (let ((let84 (ite let3 let12 let15)))
  (let ((let85 (= let40 let84)))
  (let ((let86 (ite let7 let12 let15)))
  (let ((let87 (= let59 let86)))
  (let ((let88 (ite let9 let12 let15)))
  (let ((let89 (= let68 let88)))
  (let ((let90 (ite let5 let12 let15)))
  (let ((let91 (= let47 let90)))
