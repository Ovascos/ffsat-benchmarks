...
(assert 
  ...
  (let ((let22 (and let21 let16)))
  (let ((let23 (ite let2 let6 let9)))
  (let ((let24 (= let18 let23)))
  (let ((let25 (ite let1 let6 let9)))
  (let ((let26 x2_n3))
  (let ((let27 (= let26 let25)))
  (let ((let28 (ite let3 let6 let9)))
  (let ((let29 (= let19 let28)))
  (let ((let30 (ite let0 let6 let9)))
  (let ((let31 (= let13 let30)))
