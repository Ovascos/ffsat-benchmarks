...
(assert 
  ...
  (let ((let53 x3_n7_alt))
  (let ((let54 mul_n20_alt))
  (let ((let55 (ff.mul let54 let53)))
  (let ((let56 (= let55 let50)))
  (let ((let57 x2_n18_alt))
  (let ((let58 mul_n19_alt))
  (let ((let59 (ff.mul let58 let57)))
  (let ((let60 (= let59 let54)))
  (let ((let61 x1_n13_alt))
  (let ((let62 x0_n5_alt))
  (let ((let63 (ff.mul let62 let61)))
  (let ((let64 (= let63 let58)))
  (let ((let65 (and let64 let60 let56 let52 let48 let44 let40 let36 let32 let28 let24 let20 let16 let12 let8 let4)))
  (let ((let66 mul_n34))
  (let ((let67 x16_n3))
  (let ((let68 mul_n33))
  ...
  (let ((let131 (and let130 let126 let122 let118 let114 let110 let106 let102 let98 let94 let90 let86 let82 let78 let74 let70)))
  (let ((let132 return_n17_alt))
  (let ((let133 return_n17))
  (let ((let134 (= let133 let132)))
  (let ((let135 (not let134)))
  (let ((let136 (= let75 let9)))
  (let ((let137 (= let99 let33)))
  (let ((let138 (= let87 let21)))
  (let ((let139 (= let115 let49)))
  (let ((let140 x17_n11_alt))
  (let ((let141 x17_n11))
  (let ((let142 (= let141 let140)))
  (let ((let143 (= let95 let29)))
  (let ((let144 (= let123 let57)))
  (let ((let145 (= let111 let45)))
  (let ((let146 (= let127 let61)))
  (let ((let147 (= let79 let13)))
  (let ((let148 (= let67 let1)))
  (let ((let149 (= let103 let37)))
  (let ((let150 (= let83 let17)))
  (let ((let151 (= let128 let62)))
  (let ((let152 (= let119 let53)))
  (let ((let153 (= let91 let25)))
  (let ((let154 (= let107 let41)))
  (let ((let155 (= let71 let5)))
  (let ((let156 (and let155 let154 let153 let152 let151 let150 let149 let148 let147 let146 let145 let144 let143 let142 let139 let138 let137 let136)))
  (let ((let157 (and let156 let135 let131 let65)))
  let157
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
