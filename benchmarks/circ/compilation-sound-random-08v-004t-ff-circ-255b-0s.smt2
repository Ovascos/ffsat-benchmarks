...
(assert 
  ...
  (let ((let40 a_n0))
  (let ((let41 (ff.mul let40 let21)))
  (let ((let42 (ff.add let41 let13)))
  (let ((let43 f_n1))
  ...
  (let ((let55 (= let54 let25)))
  (let ((let56 (and let55 let47 let39 let34)))
  (let ((let57 (ite let6 let13 let16)))
  (let ((let58 (= let24 let57)))
  (let ((let59 (ite let9 let13 let16)))
  (let ((let60 (= let28 let59)))
  (let ((let61 (ite let1 let13 let16)))
  (let ((let62 (= let51 let61)))
  (let ((let63 (ite let3 let13 let16)))
  (let ((let64 (= let40 let63)))
  (let ((let65 (ite let7 let13 let16)))
  (let ((let66 (= let26 let65)))
  (let ((let67 (ite let0 let13 let16)))
  (let ((let68 (= let48 let67)))
  (let ((let69 (ite let4 let13 let16)))
  (let ((let70 (= let43 let69)))
  (let ((let71 (ite let10 let13 let16)))
  (let ((let72 (= let22 let71)))
  (let ((let73 (and let72 let70 let68 let66 let64 let62 let60 let58)))
  (let ((let74 (and let73 let56)))
  (let ((let75 (=> let74 let19)))
  (let ((let76 (not let75)))
  let76
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
