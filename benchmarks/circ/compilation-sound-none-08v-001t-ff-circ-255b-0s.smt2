...
(assert 
  ...
  (let ((let37 (ite let2 let10 let13)))
  (let ((let38 (= let21 let37)))
  (let ((let39 (ite let4 let10 let13)))
  (let ((let40 (= let17 let39)))
  (let ((let41 (ite let6 let10 let13)))
  (let ((let42 (= let24 let41)))
  (let ((let43 (ite let7 let10 let13)))
  (let ((let44 (= let20 let43)))
  (let ((let45 (ite let0 let10 let13)))
  (let ((let46 (= let18 let45)))
  (let ((let47 (ite let5 let10 let13)))
  (let ((let48 (= let22 let47)))
  (let ((let49 (ite let3 let10 let13)))
  (let ((let50 (= let19 let49)))
