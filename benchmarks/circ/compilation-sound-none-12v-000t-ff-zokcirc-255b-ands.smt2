...
(assert 
  ...
  (let ((let67 (= let53 let66)))
  (let ((let68 (ite let3 let14 let17)))
  (let ((let69 (= let33 let68)))
  (let ((let70 (ite let10 let14 let17)))
  (let ((let71 (= let61 let70)))
  (let ((let72 (ite let6 let14 let17)))
  (let ((let73 (= let45 let72)))
  (let ((let74 (ite let9 let14 let17)))
  (let ((let75 (= let57 let74)))
  (let ((let76 (ite let1 let14 let17)))
  (let ((let77 (= let25 let76)))
  (let ((let78 (ite let0 let14 let17)))
  (let ((let79 (= let21 let78)))
  (let ((let80 (ite let4 let14 let17)))
  (let ((let81 (= let37 let80)))
  (let ((let82 (ite let11 let14 let17)))
  (let ((let83 (= let62 let82)))
  (let ((let84 (ite let7 let14 let17)))
  (let ((let85 (= let49 let84)))
  (let ((let86 (ite let2 let14 let17)))
  (let ((let87 (= let29 let86)))
  (let ((let88 (ite let5 let14 let17)))
  (let ((let89 (= let41 let88)))
