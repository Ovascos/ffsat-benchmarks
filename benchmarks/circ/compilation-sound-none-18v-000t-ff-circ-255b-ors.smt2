...
(assert 
  ...
  (let ((let47 (ff.mul let19 let46)))
  (let ((let48 (ff.add let47 let20)))
  (let ((let49 (ff.mul let48 let45)))
  (let ((let50 (= let49 let23)))
  (let ((let51 is_zero_inv_n19))
  (let ((let52 (ff.mul let51 let45)))
  (let ((let53 (= let52 let19)))
  (let ((let54 (and let53 let50)))
  (let ((let55 (ite let6 let20 let23)))
  (let ((let56 (= let30 let55)))
  (let ((let57 (ite let2 let20 let23)))
  (let ((let58 (= let31 let57)))
  (let ((let59 (ite let4 let20 let23)))
  (let ((let60 (= let41 let59)))
  (let ((let61 (ite let12 let20 let23)))
  (let ((let62 (= let36 let61)))
  (let ((let63 (ite let7 let20 let23)))
  (let ((let64 (= let34 let63)))
  (let ((let65 (ite let13 let20 let23)))
  (let ((let66 (= let39 let65)))
  (let ((let67 (ite let8 let20 let23)))
  (let ((let68 (= let29 let67)))
  (let ((let69 (ite let5 let20 let23)))
  (let ((let70 (= let44 let69)))
  (let ((let71 (ite let3 let20 let23)))
  (let ((let72 (= let28 let71)))
  (let ((let73 (ite let17 let20 let23)))
  (let ((let74 (= let40 let73)))
  (let ((let75 (ite let10 let20 let23)))
  (let ((let76 (= let43 let75)))
  (let ((let77 (ite let14 let20 let23)))
  (let ((let78 (= let35 let77)))
  (let ((let79 (ite let9 let20 let23)))
  (let ((let80 (= let33 let79)))
  (let ((let81 (ite let0 let20 let23)))
  (let ((let82 (= let42 let81)))
  (let ((let83 (ite let1 let20 let23)))
  (let ((let84 (= let27 let83)))
  (let ((let85 (ite let16 let20 let23)))
  (let ((let86 (= let37 let85)))
  (let ((let87 (ite let15 let20 let23)))
  (let ((let88 (= let32 let87)))
  (let ((let89 (ite let11 let20 let23)))
  (let ((let90 (= let38 let89)))
  (let ((let91 (and let90 let88 let86 let84 let82 let80 let78 let76 let74 let72 let70 let68 let66 let64 let62 let60 let58 let56)))
  (let ((let92 (and let91 let54)))
  (let ((let93 (=> let92 let26)))
  (let ((let94 (not let93)))
  let94
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
