...
(assert 
  ...
  (let ((let41 (= let24 let5)))
  (let ((let42 (= let23 let4)))
  (let ((let43 (= let22 let3)))
  (let ((let44 (= let30 let11)))
  (let ((let45 (= let28 let9)))
  (let ((let46 (= let29 let10)))
  (let ((let47 (= let32 let13)))
  (let ((let48 (= let33 let14)))
  (let ((let49 (= let31 let12)))
  (let ((let50 (= let26 let7)))
  (let ((let51 (= let20 let1)))
  (let ((let52 (= let27 let8)))
  (let ((let53 (= let25 let6)))
