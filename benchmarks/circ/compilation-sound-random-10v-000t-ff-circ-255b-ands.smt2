...
(assert 
  ...
  (let ((let47 (ite let9 let12 let15)))
  (let ((let48 (= let31 let47)))
  (let ((let49 (ite let7 let12 let15)))
  (let ((let50 (= let39 let49)))
  (let ((let51 (ite let1 let12 let15)))
  (let ((let52 (= let41 let51)))
  (let ((let53 (ite let2 let12 let15)))
  (let ((let54 (= let37 let53)))
  (let ((let55 (ite let6 let12 let15)))
  (let ((let56 (= let33 let55)))
  (let ((let57 (ite let0 let12 let15)))
  (let ((let58 (= let27 let57)))
  (let ((let59 (ite let3 let12 let15)))
  (let ((let60 (= let25 let59)))
  (let ((let61 (ite let5 let12 let15)))
  (let ((let62 (= let29 let61)))
  (let ((let63 (ite let4 let12 let15)))
  (let ((let64 (= let35 let63)))
  (let ((let65 (ite let8 let12 let15)))
  (let ((let66 (= let23 let65)))
