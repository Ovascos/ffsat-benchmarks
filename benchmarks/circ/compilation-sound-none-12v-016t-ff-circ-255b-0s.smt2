...
(assert 
  ...
  (let ((let101 l_n1))
  (let ((let102 a_n12))
  (let ((let103 (ff.mul let41 let38)))
  (let ((let104 (ff.add let86 let103 let80 let102 let101 let76 let36)))
  (let ((let105 (ff.mul let37 let104)))
  (let ((let106 (= let105 let32)))
  (let ((let107 (ff.mul let37 let38)))
  (let ((let108 (ff.add let107 let29)))
  (let ((let109 is_zero_inv_n17))
  (let ((let110 (ff.mul let109 let104)))
  (let ((let111 (= let110 let108)))
  (let ((let112 e_n4))
  (let ((let113 (ff.mul let112 let38)))
  (let ((let114 (ff.add let113 let29)))
  (let ((let115 f_n2))
  (let ((let116 (ff.mul let115 let114)))
  (let ((let117 (= let116 let85)))
  (let ((let118 b_n11))
  (let ((let119 (ff.add let77 let118)))
  (let ((let120 (ff.add let59 let82)))
  (let ((let121 (ff.mul let120 let119)))
  (let ((let122 (= let121 let80)))
  (let ((let123 (ff.mul let59 let38)))
  (let ((let124 (ff.add let102 let123)))
  (let ((let125 (ff.mul let76 let124)))
  (let ((let126 (= let125 let82)))
  (let ((let127 (ff.mul let118 let58)))
  (let ((let128 (= let127 let41)))
  (let ((let129 (and let128 let126 let122 let117 let111 let106 let100 let96 let92 let89 let74 let69 let61 let57 let51 let48)))
  (let ((let130 (ite let2 let29 let32)))
  (let ((let131 (= let118 let130)))
  (let ((let132 (ite let6 let29 let32)))
  (let ((let133 (= let59 let132)))
  (let ((let134 (ite let7 let29 let32)))
  (let ((let135 (= let102 let134)))
  (let ((let136 (ite let16 let29 let32)))
  (let ((let137 (= let62 let136)))
  (let ((let138 (ite let12 let29 let32)))
  (let ((let139 (= let115 let138)))
  (let ((let140 (ite let19 let29 let32)))
  (let ((let141 (= let78 let140)))
  (let ((let142 (ite let18 let29 let32)))
  (let ((let143 (= let84 let142)))
  (let ((let144 (ite let0 let29 let32)))
  (let ((let145 (= let58 let144)))
  (let ((let146 (ite let10 let29 let32)))
  (let ((let147 (= let101 let146)))
  (let ((let148 (ite let11 let29 let32)))
  (let ((let149 (= let112 let148)))
  (let ((let150 (ite let17 let29 let32)))
  (let ((let151 (= let52 let150)))
  (let ((let152 (ite let5 let29 let32)))
  (let ((let153 (= let76 let152)))
  (let ((let154 (and let153 let151 let149 let147 let145 let143 let141 let139 let137 let135 let133 let131)))
  (let ((let155 (and let154 let129)))
  (let ((let156 (=> let155 let35)))
