...
(assert 
  ...
  (let ((let54 (= let27 let53)))
  (let ((let55 (ite let3 let14 let17)))
  (let ((let56 (= let47 let55)))
  (let ((let57 (ite let0 let14 let17)))
  (let ((let58 (= let31 let57)))
  (let ((let59 (ite let2 let14 let17)))
  (let ((let60 (= let37 let59)))
  (let ((let61 (ite let11 let14 let17)))
  (let ((let62 (= let43 let61)))
  (let ((let63 (ite let1 let14 let17)))
  (let ((let64 (= let41 let63)))
  (let ((let65 (ite let4 let14 let17)))
  (let ((let66 (= let33 let65)))
  (let ((let67 (ite let8 let14 let17)))
  (let ((let68 (= let45 let67)))
  (let ((let69 (ite let6 let14 let17)))
  (let ((let70 (= let39 let69)))
  (let ((let71 (ite let9 let14 let17)))
  (let ((let72 (= let29 let71)))
  (let ((let73 (ite let5 let14 let17)))
  (let ((let74 (= let35 let73)))
  (let ((let75 (ite let7 let14 let17)))
  (let ((let76 (= let25 let75)))
