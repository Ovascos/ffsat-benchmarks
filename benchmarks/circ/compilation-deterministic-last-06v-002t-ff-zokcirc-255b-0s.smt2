...
(assert 
  ...
  (let ((let58 return_n3_alt))
  (let ((let59 return_n3))
  (let ((let60 (= let59 let58)))
  (let ((let61 (not let60)))
  (let ((let62 (= let49 let21)))
  (let ((let63 b_n4_alt))
  (let ((let64 b_n4))
  (let ((let65 (= let64 let63)))
  (let ((let66 (= let37 let9)))
  (let ((let67 (= let31 let3)))
  (let ((let68 (= let52 let24)))
  (let ((let69 (= let43 let15)))
  (let ((let70 (and let69 let68 let67 let66 let65 let62)))
