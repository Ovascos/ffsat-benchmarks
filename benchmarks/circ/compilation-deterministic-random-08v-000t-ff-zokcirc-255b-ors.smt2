...
(assert 
  ...
  (let ((let89 (not let88)))
  (let ((let90 (= let48 let5)))
  (let ((let91 (= let60 let17)))
  (let ((let92 (= let67 let24)))
  (let ((let93 (= let79 let36)))
  (let ((let94 (= let73 let30)))
  (let ((let95 x4_n1_alt))
  (let ((let96 x4_n1))
  (let ((let97 (= let96 let95)))
  (let ((let98 (= let54 let11)))
  (let ((let99 (= let82 let39)))
  (let ((let100 (and let99 let98 let97 let94 let93 let92 let91 let90)))
