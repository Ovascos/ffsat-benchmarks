...
(assert 
  ...
  (let ((let40 (ite let4 let8 let11)))
  (let ((let41 (= let25 let40)))
  (let ((let42 (ite let5 let8 let11)))
  (let ((let43 (= let17 let42)))
  (let ((let44 (ite let3 let8 let11)))
  (let ((let45 (= let23 let44)))
  (let ((let46 (ite let0 let8 let11)))
  (let ((let47 (= let21 let46)))
  (let ((let48 (ite let2 let8 let11)))
