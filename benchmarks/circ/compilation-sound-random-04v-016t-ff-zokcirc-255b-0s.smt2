...
(assert 
  ...
  (let ((let103 (ff.add let102 let21)))
  (let ((let104 (ff.mul let55 let103)))
  (let ((let105 (= let104 let36)))
  (let ((let106 (ff.add let102 let52 let91)))
  (let ((let107 (ff.mul let37 let106)))
  (let ((let108 (= let107 let54)))
  (let ((let109 mul_n14))
  (let ((let110 (ff.mul let109 let58)))
  (let ((let111 (= let110 let37)))
  (let ((let112 (ff.mul let58 let84)))
  (let ((let113 (= let112 let109)))
  (let ((let114 (ff.mul let75 let28)))
  (let ((let115 (ff.mul let76 let28)))
  (let ((let116 (ff.add let115 let114 let21)))
  (let ((let117 (ff.mul let76 let116)))
  (let ((let118 (= let117 let101)))
  (let ((let119 (ff.add let52 let94 let115 let93 let92 let91)))
  (let ((let120 (ff.mul let67 let119)))
  (let ((let121 (= let120 let75)))
  (let ((let122 (ff.mul let71 let42)))
  (let ((let123 (ff.mul let122 let67)))
  (let ((let124 (= let123 let94)))
  (let ((let125 (ff.add let58 let52 let91 let28)))
  (let ((let126 d_n0))
  (let ((let127 (ff.mul let126 let125)))
  (let ((let128 (= let127 let66)))
  (let ((let129 b_n3))
  (let ((let130 mul_n7))
  (let ((let131 (ff.mul let130 let129)))
  (let ((let132 (= let131 let58)))
  (let ((let133 (ff.mul let62 let126)))
  (let ((let134 (= let133 let130)))
  (let ((let135 (ff.add let76 let52 let28)))
  (let ((let136 (ff.mul let129 let135)))
  (let ((let137 (= let136 let51)))
  (let ((let138 (ff.add let93 let21)))
  (let ((let139 (ff.mul let76 let138)))
  (let ((let140 (= let139 let52)))
  (let ((let141 (and let140 let137 let134 let132 let128 let124 let121 let118 let113 let111 let108 let105 let100 let98 let90 let87 let83 let80 let74 let70 let65 let61 let57 let47 let41)))
  (let ((let142 (ite let1 let21 let24)))
  (let ((let143 (= let76 let142)))
  (let ((let144 (ite let2 let21 let24)))
  (let ((let145 (= let71 let144)))
  (let ((let146 (ite let4 let21 let24)))
  (let ((let147 (= let129 let146)))
  (let ((let148 (ite let0 let21 let24)))
  (let ((let149 (= let126 let148)))
  (let ((let150 (and let149 let147 let145 let143)))
  (let ((let151 (and let150 let141)))
  (let ((let152 (=> let151 let27)))
