...
(assert 
  ...
  (let ((let138 (= let127 let60)))
  (let ((let139 (= let109 let42)))
  (let ((let140 (= let103 let36)))
  (let ((let141 (= let115 let48)))
  (let ((let142 g_n11_alt))
  (let ((let143 g_n11))
  (let ((let144 (= let143 let142)))
  (let ((let145 (= let130 let63)))
  (let ((let146 (= let121 let54)))
  (let ((let147 (= let78 let11)))
  (let ((let148 (= let96 let29)))
  (let ((let149 (= let72 let5)))
  (let ((let150 (= let90 let23)))
  (let ((let151 (= let84 let17)))
  (let ((let152 (and let151 let150 let149 let148 let147 let146 let145 let144 let141 let140 let139 let138)))
