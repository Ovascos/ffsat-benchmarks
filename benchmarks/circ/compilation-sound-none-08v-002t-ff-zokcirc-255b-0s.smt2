...
(assert 
  ...
  (let ((let50 (ff.mul let49 let21)))
  (let ((let51 (= let50 let23)))
  (let ((let52 (and let51 let47 let43 let39 let35 let31 let27)))
  (let ((let53 (ite let5 let11 let14)))
  (let ((let54 (= let36 let53)))
  (let ((let55 (ite let1 let11 let14)))
  (let ((let56 (= let19 let55)))
  (let ((let57 (ite let7 let11 let14)))
  (let ((let58 (= let44 let57)))
  (let ((let59 (ite let6 let11 let14)))
  (let ((let60 (= let40 let59)))
  (let ((let61 (ite let3 let11 let14)))
  (let ((let62 (= let28 let61)))
  (let ((let63 (ite let4 let11 let14)))
  (let ((let64 (= let32 let63)))
  (let ((let65 (ite let8 let11 let14)))
  (let ((let66 (= let45 let65)))
  (let ((let67 (ite let0 let11 let14)))
  (let ((let68 (= let21 let67)))
  (let ((let69 (and let68 let66 let64 let62 let60 let58 let56 let54)))
  (let ((let70 (and let69 let52)))
  (let ((let71 (=> let70 let17)))
  (let ((let72 (not let71)))
  let72
)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
