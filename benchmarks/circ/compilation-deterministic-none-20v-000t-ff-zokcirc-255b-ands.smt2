...
(assert 
  ...
  (let ((let155 (and let154 let150 let146 let142 let138 let134 let130 let126 let122 let118 let114 let110 let106 let102 let98 let94 let90 let86 let82)))
  (let ((let156 (= let78 let0)))
  (let ((let157 (not let156)))
  (let ((let158 (= let143 let65)))
  (let ((let159 (= let99 let21)))
  (let ((let160 (= let87 let9)))
  (let ((let161 (= let139 let61)))
  (let ((let162 (= let151 let73)))
  (let ((let163 (= let83 let5)))
  (let ((let164 (= let147 let69)))
  (let ((let165 (= let91 let13)))
  (let ((let166 (= let135 let57)))
  (let ((let167 (= let127 let49)))
  (let ((let168 (= let152 let74)))
  (let ((let169 (= let103 let25)))
  (let ((let170 (= let131 let53)))
  (let ((let171 (= let119 let41)))
  (let ((let172 (= let123 let45)))
  (let ((let173 (= let107 let29)))
  (let ((let174 (= let79 let1)))
  (let ((let175 (= let111 let33)))
  (let ((let176 (= let95 let17)))
  (let ((let177 (= let115 let37)))
  (let ((let178 (and let177 let176 let175 let174 let173 let172 let171 let170 let169 let168 let167 let166 let165 let164 let163 let162 let161 let160 let159 let158)))
  (let ((let179 (and let178 let157 let155 let77)))
  let179
))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
)
(check-sat)
