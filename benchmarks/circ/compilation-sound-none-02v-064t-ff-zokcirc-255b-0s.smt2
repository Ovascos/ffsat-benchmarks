...
(assert 
  ...
  (let ((let370 mul_n14))
  (let ((let371 (ff.add let326 let370 let263 let67)))
  (let ((let372 (ff.mul let266 let371)))
  (let ((let373 (= let372 let367)))
  (let ((let374 mul_n29))
  (let ((let375 (ff.mul let374 let74)))
  (let ((let376 (ff.add let375 let207)))
  (let ((let377 (ff.add let131 let125 let129)))
  (let ((let378 (ff.mul let377 let376)))
  (let ((let379 (= let378 let224)))
  (let ((let380 (ff.mul let230 let74)))
  (let ((let381 (ff.add let131 let264 let263 let129 let233 let231 let380 let125 let67)))
  (let ((let382 (ff.mul let135 let381)))
  (let ((let383 (= let382 let207)))
  (let ((let384 (ff.add let131 let98 let129 let125 let74)))
  (let ((let385 (ff.mul let269 let384)))
  (let ((let386 (= let385 let126)))
  (let ((let387 (ff.mul let169 let74)))
  (let ((let388 (ff.add let235 let387 let128 let212 let67)))
  (let ((let389 (ff.add let387 let67)))
  (let ((let390 (ff.mul let389 let388)))
  (let ((let391 (= let390 let208)))
  (let ((let392 (ff.mul let173 let173)))
  (let ((let393 (= let392 let169)))
  (let ((let394 (ff.mul let286 let381)))
  (let ((let395 (= let394 let75)))
  (let ((let396 (ff.add let115 let67)))
  (let ((let397 (ff.mul let247 let396)))
  (let ((let398 (= let397 let116)))
  (let ((let399 (ff.mul let128 let138)))
  (let ((let400 (ff.mul let131 let136)))
  (let ((let401 (ff.add let400 let275 let399)))
  (let ((let402 (ff.mul let401 let265)))
  (let ((let403 (= let402 let230)))
  (let ((let404 (ff.add let183 let148 let144 let232 let74)))
  (let ((let405 (ff.add let148 let232 let144)))
  (let ((let406 (ff.mul let405 let404)))
  (let ((let407 (= let406 let233)))
  (let ((let408 mul_n44))
  (let ((let409 (ff.mul let408 let125)))
  (let ((let410 (= let409 let183)))
  (let ((let411 mul_n43))
  (let ((let412 (ff.mul let411 let353)))
  (let ((let413 (= let412 let408)))
  (let ((let414 mul_n42))
  (let ((let415 (ff.mul let414 let125)))
  (let ((let416 (= let415 let411)))
  (let ((let417 mul_n12))
  (let ((let418 (ff.add let417 let163 let67)))
  (let ((let419 mul_n41))
  (let ((let420 (ff.mul let419 let418)))
  (let ((let421 (= let420 let414)))
  (let ((let422 mul_n40))
  (let ((let423 (ff.mul let422 let353)))
  (let ((let424 (= let423 let419)))
  (let ((let425 (ff.mul let266 let266)))
  (let ((let426 (= let425 let422)))
  (let ((let427 (ff.mul let400 let125)))
  (let ((let428 (= let427 let128)))
  (let ((let429 mul_n37))
  (let ((let430 (ff.mul let429 let131)))
  (let ((let431 (= let430 let125)))
  (let ((let432 mul_n36))
  (let ((let433 (ff.mul let432 let144)))
  (let ((let434 (= let433 let429)))
  (let ((let435 mul_n35))
  (let ((let436 (ff.mul let435 let396)))
  (let ((let437 (= let436 let432)))
  (let ((let438 (ff.add let375 let67)))
  (let ((let439 mul_n34))
  ...
  (let ((let446 (ff.mul let396 let215)))
  (let ((let447 (= let446 let443)))
  (let ((let448 mul_n31))
  (let ((let449 (ff.mul let448 let321)))
  (let ((let450 (= let449 let98)))
  (let ((let451 (ff.mul let215 let74)))
  (let ((let452 (ff.add let451 let67)))
  (let ((let453 (ff.mul let417 let74)))
  (let ((let454 (ff.add let453 let111)))
  (let ((let455 (ff.mul let454 let452)))
  (let ((let456 (= let455 let448)))
  (let ((let457 (ff.add let375 let148 let144)))
  (let ((let458 (ff.mul let438 let457)))
  (let ((let459 (= let458 let231)))
  (let ((let460 mul_n28))
  (let ((let461 (ff.mul let460 let454)))
  (let ((let462 (= let461 let374)))
  (let ((let463 (ff.mul let370 let74)))
  (let ((let464 (ff.add let144 let463 let325)))
  (let ((let465 mul_n27))
  (let ((let466 (ff.mul let465 let464)))
  (let ((let467 (= let466 let460)))
  (let ((let468 (ff.mul let452 let111)))
  (let ((let469 (= let468 let465)))
  (let ((let470 mul_n25))
  (let ((let471 (ff.mul let470 let144)))
  (let ((let472 (= let471 let215)))
  (let ((let473 mul_n24))
  (let ((let474 (ff.mul let473 let325)))
  (let ((let475 (= let474 let470)))
  (let ((let476 (ff.add let148 let144)))
  (let ((let477 mul_n23))
  (let ((let478 (ff.mul let477 let476)))
  (let ((let479 (= let478 let473)))
  (let ((let480 mul_n22))
  (let ((let481 (ff.mul let480 let111)))
  (let ((let482 (= let481 let477)))
  (let ((let483 mul_n21))
  (let ((let484 (ff.mul let483 let353)))
  (let ((let485 (= let484 let480)))
  (let ((let486 mul_n20))
  (let ((let487 (ff.mul let486 let131)))
  (let ((let488 (= let487 let483)))
  (let ((let489 mul_n19))
  (let ((let490 (ff.mul let489 let325)))
  (let ((let491 (= let490 let486)))
  (let ((let492 mul_n18))
  (let ((let493 (ff.mul let492 let371)))
  (let ((let494 (= let493 let489)))
  (let ((let495 mul_n17))
  (let ((let496 (ff.mul let495 let371)))
  (let ((let497 (= let496 let492)))
  (let ((let498 (ff.add let163 let67)))
  (let ((let499 (ff.mul let476 let498)))
  (let ((let500 (= let499 let495)))
  (let ((let501 mul_n15))
  (let ((let502 (ff.mul let501 let498)))
  (let ((let503 (= let502 let131)))
  (let ((let504 (ff.mul let353 let418)))
  (let ((let505 (= let504 let501)))
  (let ((let506 (ff.mul let145 let325)))
  (let ((let507 (= let506 let370)))
  (let ((let508 (ff.add let417 let163 let263 let67)))
  (let ((let509 (ff.mul let442 let74)))
  (let ((let510 (ff.add let509 let67)))
  (let ((let511 (ff.mul let510 let508)))
  (let ((let512 (= let511 let148)))
  (let ((let513 (ff.add let111 let325 let74)))
  (let ((let514 (ff.mul let111 let513)))
  (let ((let515 (= let514 let417)))
  (let ((let516 (ff.mul let510 let442)))
  (let ((let517 (= let516 let325)))
  (let ((let518 mul_n9))
  (let ((let519 (ff.mul let518 let442)))
  (let ((let520 (= let519 let144)))
  (let ((let521 mul_n8))
  (let ((let522 (ff.mul let521 let442)))
  (let ((let523 (= let522 let518)))
  (let ((let524 mul_n7))
  (let ((let525 (ff.mul let524 let510)))
  (let ((let526 (= let525 let521)))
  (let ((let527 mul_n6))
  (let ((let528 (ff.mul let527 let442)))
  (let ((let529 (= let528 let524)))
  (let ((let530 mul_n5))
  (let ((let531 (ff.mul let530 let510)))
  (let ((let532 (= let531 let527)))
  (let ((let533 mul_n4))
  (let ((let534 (ff.mul let533 let510)))
  (let ((let535 (= let534 let530)))
  (let ((let536 mul_n3))
  (let ((let537 (ff.mul let536 let442)))
  (let ((let538 (= let537 let533)))
  (let ((let539 (ff.mul let111 let510)))
  (let ((let540 (= let539 let536)))
  (let ((let541 (and let540 let538 let535 let532 let529 let526 let523 let520 let517 let515 let512 let507 let505 let503 let500 let497 let494 let491 let488 let485 let482 let479 let475 let472 let469 let467 let462 let459 let456 let450 let447 let445 let441 let437 let434 let431 let428 let426 let424 let421 let416 let413 let410 let407 let403 let398 let395 let393 let391 let386 let383 let379 let373 let369 let366 let363 let359 let355 let351 let348 let345 let342 let339 let334 let331 let329 let324 let320 let315 let309 let306 let303 let301 let298 let295 let292 let285 let281 let273 let268 let262 let259 let252 let245 let239 let229 let223 let220 let211 let206 let200 let195 let187 let179 let176 let172 let168 let162 let158 let152 let143 let134 let121 let109 let103 let96 let88 let84 let80)))
  (let ((let542 (ite let2 let67 let70)))
  (let ((let543 (= let111 let542)))
  (let ((let544 (ite let0 let67 let70)))
  (let ((let545 (= let442 let544)))
  (let ((let546 (and let545 let543)))
  (let ((let547 (and let546 let541)))
  (let ((let548 (=> let547 let73)))
