...
(assert 
  ...
  (let ((let53 (ite let5 let14 let17)))
  (let ((let54 (= let47 let53)))
  (let ((let55 (ite let4 let14 let17)))
  (let ((let56 (= let37 let55)))
  (let ((let57 (ite let6 let14 let17)))
  (let ((let58 (= let31 let57)))
  (let ((let59 (ite let9 let14 let17)))
  (let ((let60 (= let35 let59)))
  (let ((let61 (ite let10 let14 let17)))
  (let ((let62 (= let45 let61)))
  (let ((let63 (ite let0 let14 let17)))
  (let ((let64 (= let39 let63)))
  (let ((let65 (ite let1 let14 let17)))
  (let ((let66 (= let25 let65)))
  (let ((let67 (ite let8 let14 let17)))
  (let ((let68 (= let27 let67)))
  (let ((let69 (ite let2 let14 let17)))
