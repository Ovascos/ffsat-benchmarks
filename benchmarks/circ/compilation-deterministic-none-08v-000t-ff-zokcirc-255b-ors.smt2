...
(assert 
  ...
  (let ((let99 (not let98)))
  (let ((let100 (= let71 let23)))
  (let ((let101 (= let53 let5)))
  (let ((let102 (= let83 let35)))
  (let ((let103 (= let89 let41)))
  (let ((let104 (= let59 let11)))
  (let ((let105 (= let77 let29)))
  (let ((let106 (= let92 let44)))
