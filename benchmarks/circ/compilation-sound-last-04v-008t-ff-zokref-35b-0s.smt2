...
(assert 
  ...
  (let ((let28 (as ff17179869208 FF0)))
  (let ((let29 _21))
  ...
  (let ((let122 (ite let2 let12 let15)))
  (let ((let123 (= let51 let122)))
  (let ((let124 (ite let1 let12 let15)))
  (let ((let125 (= let69 let124)))
  (let ((let126 (ite let0 let12 let15)))
  (let ((let127 (= let20 let126)))
